...
import { Recycle, Trash2, Users, TrendingUp, ArrowRight, Target, Leaf, Briefcase } from 'lucide-react'
...
const components = [
  {
    ...
    description: 'Efficient collection and sorting of recyclable materials',
    color: 'from-blue-500 to-cyan-600',
  },
  {
    icon: Users,
    title: 'Community Engagement',
    description: 'Training and involving local communities in waste management',
    color: 'from-purple-500 to-pink-600',
  },
  {
    icon: Briefcase,
    title: 'Economic Opportunities',
    description: 'Creating jobs and income through recycling activities',
...
export default function RECOProject() {
  return (
    <div className="pt-20">
      {/* Hero Section */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
              Resource Collection & Recycling - Transforming waste into opportunity
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                ...
                effects on communities and their environment. The RECO (Resource Collection) 
                project addresses this by creating sustainable waste collection and recycling 
                systems.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Through systematic collection, sorting, and processing of recyclable materials, 
                RECO transforms waste into valuable resources while creating economic opportunities 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Project Components</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { metric: 'Jobs Created', value: '50+', icon: Briefcase },
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl font-bold mb-6">Support RECO Project</h2>
            <p className="text-xl mb-8 text-white/90">
              Help us create a cleaner, more sustainable Mombasa County through recycling.
            </p>
